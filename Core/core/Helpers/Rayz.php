...
/**
 * Handle and Manipulate Arrays
 * Query Arrays like CI3 Model
 * 
 * Credit: https://github.com/nobitadore/Arrayz
 * Improved for WebbyPHP
 * 
 * Version - 1.0.0
 */
...
class Rayz
{
	 ...
	 */
	public function __invoke($source = []): Rayz
	{
		$this->source = $source;
		return $this;
	}
	 ...
	 * @return \Base\Helpers\Rayz
	 */
	public function use($type = 'serialize'): Rayz
	{
		$this->cacheAs = $type;
	 ...
	 * @return \Base\Helpers\Rayz
	 */
	public function cache($item): Rayz
	{
	 ...
	 * 
	 */
	public function whereLike(): Rayz
	{
		$arguments = func_get_args();
		$option = [];
		$side = 'in';
	 ...
	 * @return \Base\Helpers\Rayz
	 */
	public function paginate($array, $page = 1, $perPage = 100): Rayz
	{
		$pagination = [
			'length' => $perPage,
			'total' => sizeof($array),
...
/*
	...
	*/
	 ...
	 * @return \Base\Helpers\Rayz
	 */
	public function censorKeys($keys): Rayz
	{
		if (is_string($keys)) {
			$keys = [$keys];
		}
	 ...
	 * @return \Base\Helpers\Rayz
	 */
	public function whereNotIn(): Rayz
	{
		$arguments = func_get_args();
		$option = [];
